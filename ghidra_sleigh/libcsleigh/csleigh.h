...
LPX(TranslationResult) *LPX(translate)(LPX(Context) c, uintb address, unsigned int max_instructions, bool bb_terminating);
...
bool LPX(isConstSpace)(LPX(AddrSpace) as);
bool LPX(isRegisterSpace)(LPX(AddrSpace) as);
bool LPX(isRamSpace)(LPX(AddrSpace) as);
bool LPX(isUniqueSpace)(LPX(AddrSpace) as);

bool LPX(isConst)(LPX(Translation) *vnode);
bool LPX(isRegister)(LPX(Translation) *vnode);
bool LPX(isRam)(LPX(Translation) *vnode);
bool LPX(isUnique)(LPX(Translation) *vnode);
