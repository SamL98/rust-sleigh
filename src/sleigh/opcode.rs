...
impl OpCode {
    pub fn from_str(s: &str) -> Self {
        match s {
            ...
            "FLOAT_INT2FLOAT" => OpCode::FloatInt2Float,
            "FLOAT_FLOAT2FLOAT" => OpCode::FloatFloat2Float,
            "FLOAT_TRUNC" => OpCode::FloatTrunc,
            "FLOAT_CEIL" => OpCode::FloatCeil,
            "FLOAT_FLOOR" => OpCode::FloatFloor,
            "FLOAT_ROUND" => OpCode::FloatRound,
